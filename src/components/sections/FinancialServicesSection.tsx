      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        ...
        <RevealOnScroll>
          <header className="flex flex-col items-start gap-4 mb-10 lg:mb-14">
            <h2 className="text-3xl md:text-5xl font-bold font-bodoni text-sandstone-500 tracking-normal">
              Financial Services
            </h2>
            <div className="text-[#a8a5a0] text-base md:text-2xl font-cormorant relative">
              ...
              <span className="text-base md:text-2xl font-albert font-light">— embedded finance for residents</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 items-center border border-[#4A4741]/15 shadow-[0_16px_40px_rgba(0,0,0,0.15)] bg-[#4A4741]/5 backdrop-blur-xl transition-opacity rounded-[2.5rem] overflow-hidden">
            ...
            <div className="flex flex-col justify-end p-2 lg:pb-10 lg:pr-10 h-full">
              <RevealOnScroll delay="delay-100">
                <h3 className="text-2xl md:text-4xl font-semibold font-cormorant tracking-normal text-sandstone-500 leading-[1.1] transition-all duration-500 lg:mb-4">
                  {activeCard.title}
                </h3>
                <p className="text-lg md:text-xl text-[#1C1B1A]/70 font-albert leading-relaxed max-w-md font-normal">
