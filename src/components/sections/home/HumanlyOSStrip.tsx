...
export const HumanlyOSSection = () => {
  return (
    <section className="relative w-full py-8 lg:py-16 overflow-hidden min-h-[680px] lg:min-h-[780px]">
      ...
      />
      <div className="absolute top-0 left-0 w-full h-48 bg-gradient-to-b from-sandstone-200 to-transparent z-0" />
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-sandstone-200 to-transparent z-0" />
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 h-full flex flex-col justify-between">
        <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-[4%]">
          <RevealOnScroll
            delay="delay-100"
            className="w-full lg:w-[63%] flex flex-col justify-end pt-48 lg:pt-64 pb-4"
          >
            <div className="mb-6">
            ...
            <p className="text-left text-white/90 font-light font-albert leading-relaxed text-base md:text-lg max-w-[640px]">
              The AI-native operating system that transforms community
              management from fragmented services into an integrated,
            ...
            {features.map((feature) => (
              <div key={feature.id} className="flex-1">
                <article className="relative flex h-44 flex-col justify-center rounded-3xl group transition-colors duration-500 shadow-[0_16px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.25)]">
                  <div className="absolute inset-0 rounded-3xl bg-black/15 backdrop-blur-xl border border-white/20" />

                  <div className="relative z-10 p-6 lg:p-8 flex flex-col h-full justify-center">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-left leading-tight font-light font-cormorant text-2xl text-[#f7f1e8]">
                        {feature.title}
                      </h3>
          ...
          <div className="md:hidden mt-4 pt-4 overflow-visible w-full">
            <div
            ...
            >
              {features.map((feature) => (
                ...
                >
                  <div className="absolute inset-0 rounded-3xl bg-black/15 backdrop-blur-md border border-white/30" />

                  <div className="relative z-10 p-6 flex flex-col h-full justify-center">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-left text-[#f7f1e8] leading-tight font-bold text-[1.25rem]">
                        {feature.title}
                      </h3>
                      <div className="text-white/80 shrink-0 ml-3">
                        <feature.icon className="w-6 h-6" strokeWidth={1.5} />
