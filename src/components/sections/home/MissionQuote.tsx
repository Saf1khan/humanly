  ...
  return (
    <section className="relative h-[720px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-sandstone-200 to-sandstone-200/95 z-10"></div>
        <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-sandstone-200 to-sandstone-200/95 z-10"></div>
        <div
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 relative z-10 text-center w-full flex flex-col items-center">
        <motion.p
          ...
          className="text-white text-xs uppercase tracking-[0.4em] mb-4 font-bold"
        >
          OUR CORE MISSION
        </motion.p>
