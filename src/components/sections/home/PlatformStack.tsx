  ...
  return (
    <section className="text-sandstone-500 bg-transparent py-12 lg:pt-24 lg:pb-40 relative z-10 w-full overflow-x-clip">
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 50%, rgba(var(--radial-gradient-color, 107, 206, 255), 0.25), rgba(var(--radial-gradient-color, 107, 206, 255), 0.09) 50%, rgba(var(--radial-gradient-color, 107, 206, 255), 0))",
        }}
      />
