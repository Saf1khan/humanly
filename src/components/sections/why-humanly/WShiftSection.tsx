...
export const WShiftSection = () => {
  ...
  return (
    <section className="gl-b-cta bg-neutral-800 px-4 py-16 md:px-8 md:py-20 lg:py-24 w-full font-['Albert_Sans',-apple-system,BlinkMacSystemFont,sans-serif] rounded-b-[40px] md:rounded-b-[64px] relative z-20 overflow-hidden">
      ...
      >
        ...
        <div className="left-content flex-1 basis-[100%] md:basis-[39.325%] lg:basis-1/2 overflow-hidden rounded-[12px] lg:rounded-xl">
          <img
            loading="lazy"
            decoding="async"
        ...
        <div className="right-content flex flex-1 basis-[100%] items-center justify-center md:basis-[60.675%] lg:basis-1/2">
          <div className="text-container w-full px-6 py-10 md:px-8 md:py-12 lg:px-[64px]">
            ...
            <p className="mt-6 w-full font-light text-[15px] md:text-[16px] lg:text-[17px] leading-relaxed lg:w-[90%] text-[#a8a5a0]">
