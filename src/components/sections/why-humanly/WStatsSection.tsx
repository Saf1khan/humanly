...
export const WStatsSection = () => {
  ...
  return (
    <section
      ...
      style={{
        background: 'radial-gradient(ellipse 80% 60% at 20% 80%, rgba(110,124,141,.05) 0, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 20%, rgba(163,178,195,.04) 0, transparent 50%), #E7E3DC'
      }}
    >
