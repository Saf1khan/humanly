              ...
              <div className="w-full text-center lg:text-left lg:relative lg:block">
                <div ref={btnRevealRef} className="wh-btn-reveal">
                  <p className="wh-hero-desc text-[16px] leading-[24px] lg:text-lg md:text-xl text-[#e2e8f0] font-light text-balance m-0">
                    We believe where you live shapes who you can become.
                    <br className="hidden lg:block" />
                    Humanly transforms residential communities into ecosystems of opportunity — where great design, intelligent technology, and essential services converge to unlock human potential at scale.
                  </p>
                </div>
              </div>
            </div>
