...
export const CredentialsStrip = () => {
  return (
    <section className="relative w-full bg-[#faf9f6] py-24 overflow-visible">
      {/* Subtle Background Decoration */}
      <div
        className="absolute z-10 pointer-events-none left-0 top-1/5 -translate-x-1/2 -translate-y-1/2 w-[clamp(44rem,14.769rem+116.923vw,120rem)] h-[clamp(25rem,8.654rem+65.385vw,67.5rem)]"
        style={{ background: "radial-gradient(50% 50%, rgba(255, 182, 55, 0.06), rgba(255, 182, 55, 0.04) 50%, rgba(255, 182, 55, 0))" }}
      />
      <div
        className="absolute z-10 pointer-events-none bottom-1/2 translate-x-1/2 translate-y-1/2 w-[clamp(44rem,14.769rem+116.923vw,120rem)] h-[clamp(25rem,8.654rem+65.385vw,67.5rem)]"
        style={{ background: "radial-gradient(50% 50%, rgba(255, 182, 55, 0.07), rgba(255, 182, 55, 0.04) 50%, rgba(255, 182, 55, 0))" }}
      />
