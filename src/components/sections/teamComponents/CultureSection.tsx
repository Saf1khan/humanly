...
export const CultureSection = () => {
  return (
    ...
    <section className="relative w-full bg-[#5C6F5D] py-16 md:py-24 lg:py-32 overflow-hidden rounded-b-[40px] md:rounded-b-[64px]">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[560px] gap-10 md:gap-16 lg:gap-24 items-start">
            ...
            <div className="flex flex-col justify-center">
              ...
              <motion.div
                className="h-[1px] w-full max-w-[508px] bg-gradient-to-r from-white/50 to-transparent my-6 lg:my-8"
              ...
              <motion.div
                className="space-y-6 text-white/70 text-[1.0625rem] leading-relaxed max-w-[52ch] font-light mb-6 lg:mb-8"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 2.5, ease: [0.16, 1, 0.3, 1] }}
