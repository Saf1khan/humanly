      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[64px] h-full flex flex-col justify-between">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-[4%]">
          ...
          <RevealOnScroll delay="delay-100" className="w-full lg:w-[63%] flex flex-col justify-end pt-48 lg:pt-64 pb-4">
            <div className="mb-4">
              <div className="py-1 rounded-3xl uppercase inline-block bg-black/15 backdrop-blur-md text-sm px-3">
                <p className="text-left text-white tracking-[0.2em] leading-normal font-albert font-medium">
                  THE OPERATING SYSTEM
                </p>
              </div>
            </div>

            <h2 className="text-left text-white leading-tight font-bold mb-4 text-4xl md:text-5xl font-bodoni tracking-wide">
              HumanlyOS<sup>&reg;</sup>
            </h2>
            <p className="text-left text-white/90 leading-relaxed text-[1rem] md:text-[1.125rem] max-w-xl font-albert font-normal">
                ...
                <article className="relative flex h-44 flex-col justify-center rounded-3xl group transition-colors duration-500 shadow-[0_16px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.25)]">
                  ...
                  <div className="relative z-10 p-6 lg:p-8 flex flex-col h-full justify-center">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <h2 className="text-left leading-tight font-semibold tracking-wide text-2xl font-cormorant text-[#f7f1e8]">
                        {feature.title}
                      </h2>
                    ...
                    <p className="text-left text-white/70 font-albert text-base font-normal">
                      {feature.description}
                    </p>
                  </div>
                </article>
              ...
              {features.map((feature) => (
                ...
                >
                  ...
                  <div className="relative z-10 p-6 flex flex-col h-full justify-center">
                    {/* ── Title + icon row ── */}
                    <div className="flex items-center justify-between mb-2">
                      <h2 className="text-left text-[#f7f1e8] leading-tight font-cormorant font-semibold text-xl tracking-wide">
                        {feature.title}
                      </h2>
                      <div className="text-white/80 shrink-0 ml-3">
                        <feature.icon className="w-6 h-6" strokeWidth={1.5} />
                    ...
                    <p className="text-left text-white/70 font-albert text-sm font-normal">
                      {feature.description}
                    </p>
                  </div>
                </article>
